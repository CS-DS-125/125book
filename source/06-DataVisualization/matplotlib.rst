...
.. note::
   ...
   - `Jhub
     <https://jhub.iwu.edu/hub/user-redirect/git-pull?repo=https%3A%2F%2Fgithub.com%2FCS-DS-125%2F125exercises-s19&branch=master&urlPath=lab/tree/125exercises-s19/ch06/howto_matplotlib.ipynb>`_
     (for students in IWU's CS/DS course)
   - `Binder
     <https://mybinder.org/v2/gh/CS-DS-125/125exercises-s19/master?filepath=ch06%2Fhowto_matplotlib.ipynb>`_
     (for anyone else)
